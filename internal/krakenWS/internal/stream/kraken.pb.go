...
type TickerInformation struct {
	...
	B []*anypb.Any `protobuf:"bytes,2,rep,name=b,proto3" json:"b,omitempty"`
	V []*anypb.Any `protobuf:"bytes,3,rep,name=v,proto3" json:"v,omitempty"`
	L []*anypb.Any `protobuf:"bytes,4,rep,name=l,proto3" json:"l,omitempty"`
	H []*anypb.Any `protobuf:"bytes,5,rep,name=h,proto3" json:"h,omitempty"`
	O []*anypb.Any `protobuf:"bytes,6,rep,name=o,proto3" json:"o,omitempty"`
}
...
func (x *TickerInformation) GetA() []*anypb.Any {
	if x != nil {
		return x.A
	}
	return nil
...
func (x *TickerInformation) GetB() []*anypb.Any {
	if x != nil {
		return x.B
	}
	return nil
...
func (x *TickerInformation) GetV() []*anypb.Any {
	if x != nil {
		return x.V
	}
	return nil
...
func (x *TickerInformation) GetL() []*anypb.Any {
	if x != nil {
		return x.L
	}
	return nil
...
func (x *TickerInformation) GetH() []*anypb.Any {
	if x != nil {
		return x.H
	}
	return nil
...
func (x *TickerInformation) GetO() []*anypb.Any {
	if x != nil {
		return x.O
	}
	return nil
...
// Typecode generated from: "KrakenSubscriptionData"
const KrakenSubscriptionDataTypeCode uint32 = 3417847263

// Typecode generated from: "KrakenWsMessageIncoming"
const KrakenWsMessageIncomingTypeCode uint32 = 306288858

// Typecode generated from: "KrakenWsMessageOutgoing"
const KrakenWsMessageOutgoingTypeCode uint32 = 895346688

// Typecode generated from: "TickerInformation"
const TickerInformationTypeCode uint32 = 2611176034

// Typecode generated from: "TickerMessage"
const TickerMessageTypeCode uint32 = 2405484249
